...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/monalisa-project/monalisa>";
    const std::string URL_WEBSITE = "<https://monalisa.org>";
