...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s monalisa-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  monalisa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded monalisa transaction") + "\n" +
              "  monalisa-tx [options] -create [commands]   " + _("Create hex-encoded monalisa transaction") + "\n" +
              "\n";
