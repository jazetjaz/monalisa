...
#if defined(NDEBUG)
# error "Monalisa cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Monalisa Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MNL additional fees, %d delta bytes\n",
