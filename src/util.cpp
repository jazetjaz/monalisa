...
const char * const BITCOIN_CONF_FILENAME = "monalisa.conf";
const char * const BITCOIN_PID_FILENAME = "monalisa.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Monalisa";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Monalisa";
#else
    // Unix
    return pathRet / ".monalisa";
#endif
#endif
}
